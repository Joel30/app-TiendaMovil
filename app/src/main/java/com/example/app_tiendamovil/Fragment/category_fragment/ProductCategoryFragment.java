...
public class ProductCategoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mFA = inflater.inflate(R.layout.fragment_product_category, container, false);
        loadComponents();
        return mFA;
    }
    ...
    private void loadComponents() {
        ...
        txt_category = (TextView) mFA.findViewById(R.id.txt_show_category);
        txt_category.setText(Utils.CATEGORY);
        getDataFavorite();
    ...
    public void getData() {
        final GridView list = (GridView) mFA.findViewById(R.id.grid_category);
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    for (int i = 0; i < data.length(); i++){
                        ...
                        if  (!obj.getString("idpeople").equals(Utils.ID) && Utils.CATEGORY.equals(obj.getString("category"))){
                            int box = 0;
